...
def test_cleaner(domains_config, deployments_manager):
    ...
    # got a node in cluster - cleanup pod created - got a cache directory - but worker is available - no action performed
    ...
    domains_config.set_worker_available('example007.com', 'host.name.internal')
    with domains_config.get_redis() as r:
