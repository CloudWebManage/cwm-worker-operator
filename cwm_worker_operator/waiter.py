...
def check_deployment_complete(domains_config, waiter_metrics, deployments_manager, flow_manager, worker_id, check_for_error=False):
...
def run_single_iteration(domains_config: domains_config.DomainsConfig, metrics, deployments_manager, **_):
    ...
    for worker_id in flow_manager.iterate_worker_ids_waiting_for_deployment_complete():
        ...
        check_deployment_complete(domains_config, waiter_metrics, deployments_manager, flow_manager, worker_id, check_for_error)
