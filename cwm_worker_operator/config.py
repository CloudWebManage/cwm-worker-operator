...
METRICS_UPDATER_TEN_MINUTES_RETENTION_SIZE = int(os.environ.get('METRICS_UPDATER_TEN_MINUTES_RETENTION_SIZE') or '6')
METRICS_UPDATER_HOURS_RETENTION_SIZE = int(os.environ.get('METRICS_UPDATER_HOURS_RETENTION_SIZE') or '6')
METRICS_UPDATER_DAYS_RETENTION_SIZE = int(os.environ.get('METRICS_UPDATER_DAYS_RETENTION_SIZE') or '6')
